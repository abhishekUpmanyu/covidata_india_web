...
import 'package:covidata_web/views/district_view_desktop.dart';
import 'package:covidata_web/views/state_view_desktop.dart';
import 'package:flutter/material.dart';

class SearchViewDesktop extends StatefulWidget {
  @override
  _SearchViewDesktopState createState() => _SearchViewDesktopState();
}

class _SearchViewDesktopState extends State<SearchViewDesktop> {
          ...
          onTap: () {
            Navigator.of(context).pushReplacement(MaterialPageRoute(
                builder: (BuildContext context) => index < _states.length
                    ? StateViewDesktop(Data.caseData.states.indexWhere((data) => data.stateCode==_states[index].stateCode))
                    : DistrictViewDesktop(_districts[index - _states.length])));},
          child: Padding(
